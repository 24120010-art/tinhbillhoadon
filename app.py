...
st.image("d1dad8e96344bb0f19283536c9817afa.jpg")
...
if page == "🍽️ Order":
    st.title("🍽️ Hệ thống Order Nhà Hàng_Tứ Đại Long Vương")
